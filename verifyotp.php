        ...
        <div class="form-hnyv-sec py-sm-5 py-3">
            ...
            <?php 
             ...
             ?>
               ...
               <?php } ?>
                <h2>Verify OTP</h2>
                <form method="post" action="verifyotp.php" onsubmit="return validateform()" name="myform" id="login-form" action="">
                    <div class="form-sub-w3">
                        <input type="text" name="checkotp" placeholder="Enter OTP" required="" />
                        
                    </div>
                    
                    
                    <div class="submit-button text-center">
                        <button type="submit" class="btn btn-style btn-primary" name="sub">Submit OTP</button>
