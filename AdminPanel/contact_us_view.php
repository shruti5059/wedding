...
<?php
  require "connect.php";
  $select=mysqli_query($con,"select * from contact_us"); 
?>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td><a href="contact_us_delete.php?contact_id=<?php echo $row['contact_id']; ?>"><i class="far fa-trash-alt trash" style="font-size:20px;color:red"></i></td>
