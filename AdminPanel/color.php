 ...
 <?php
              require 'connect.php';
                if(isset($_REQUEST['sub'])){
                  ...
                  $insert=mysqli_query($con,"insert into color(color_name)values('$color_name')");
                  if($insert)
                  {
                ...
                <form method="POST">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      <label for="frist_name">Color Name</label>
                      <input id="frist_name" required type="text" class="form-control" name="color_name" autofocus required>
                    </div>
