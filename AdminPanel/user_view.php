...
<?php
  if(isset($_POST['submit'])){
    ...
    for($i=0;$i<sizeof($check);$i++){
      $a1=$check[$i];
      $del=mysqli_query($con,"delete from client_register where c_id=$a1");
    }
  }
?>
<?php 
 $sql=mysqli_query($con,"select * from client_register");
?>
        <style type="text/css">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <tbody>
                    <tr>
                     <!-- <td><input type="checkbox" name="allcheck[]" value="<?php echo $r['c_id'];?>"></td>-->
                      <td><?php echo $r['c_id'];?></td>
                      <td><?php echo $r['user_name'];?></td>
                      <td><?php echo $r['email'];?></td>
                      <td><?php echo $r['phoneno'];?></td>
                      <td><?php echo $r['address'];?></td>
                     <!-- <td><img src="images/<?php echo $r['image'];?>" width="50" height="50"></td>-->
                      <td><a href="user_delete.php?c_id=<?php echo $r['c_id']; ?>"><i class="far fa-trash-alt trash" style="font-size:20px;color:red"></i></td>
