  ...
  <?php
              require 'connect.php';
                if(isset($_REQUEST['sub'])){
                  ...
                  $insert=mysqli_query($con,"insert into jewellery(j_name)values('$j_name')");
                 if($insert)
                                {
    ...
    <?php } ?>
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" type="text" class="form-control" name="j_name" autofocus>
                    </div>
