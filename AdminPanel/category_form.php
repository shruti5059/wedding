 ...
 <?php
              require 'connect.php';
                if(isset($_REQUEST['sub'])){
                  ...
                  $insert=mysqli_query($con,"insert into category(category_name)values('$category_name')");
                 if($insert)
                                {
                 ...
                 <?php } ?>
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" type="text" required class="form-control" name="category_name" autofocus>
                    </div>
