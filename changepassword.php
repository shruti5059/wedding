<?php
    ...
    $db_pass=$_SESSION['client']['password'];
    $user_name=$_SESSION['client']['c_id'];
    ...
    { 
        ...
        $confirm=$_REQUEST['confirm'];        
            ...
            if($new == $confirm)
                {
                    $sql=mysqli_query($con,"update client_register set password='$new' where c_id='$user_name'");
          ...
          <?php } ?>
                ...
                <form action="#" method="post">
                    <!--<div class="form-sub-w3">
                        <input type="name" name="user_name" placeholder="Enter User Name" required="" />
                        
                    </div>-->
                    <div class="form-sub-w3">
                        <input type="password" name="new" placeholder="Enter New Password" required="" maxlength="6"/>
                  
                        
                    </div>
                    <div class="form-sub-w3">
                        <input type="password" name="confirm" placeholder="Enter Confirm Password" required=""  maxlength="6"/>
                        
                    </div>
                    
                    <div class="submit-button text-center">
                        <button type="submit"class="btn btn-style btn-primary" name="sub">Login Now</button>
                        <a href="index.php"class="btn btn-style btn-primary" name="cancel">CANCEL</a>
