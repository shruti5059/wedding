            ...
            <div class="container py-lg-5">
                ...
                <form method="post" action="" enctype="multiple/form-data">
                    ...
                    <div class="checkout-right">
                            ...
                            <tbody>
                                <tr class="rem1">
                                    ...
                                    <td class="invert-image"><a href="">
                                            <img src="AdminPanel/images/<?php echo $row2['image'];?>" class="img-fluid radius-image" alt=""></a></td>
                                    <td class="invert"><?php echo $row2['product_name']; ?></td>

                                    <td class="invert"><?php echo $row2['price']; ?></p></td>
                                    <td class="invert">
                                        <div class="quantity">
                                            <div class="quantity-select">
                                                
                                                <div class="entry value"><span><?php echo $row2['quantity']; ?></span></div>
                                                
                                            </div>
                                        </div>
                                    </td>
                                   
                                    <td class="invert"><?php echo $row2['total']; $total=$total+$row2['total']; ?></td>
                                    <td class="invert"><a href="cart_delete.php?cart_id=<?php echo $row2['cart_id']; ?>">x</td>
                        ...
                        <a class="btn btn-danger" type="submit" href="checkout.php">Process To CheckOut</a>
                    </div>
                    </form>
                </div>
                <!-- //about -->
