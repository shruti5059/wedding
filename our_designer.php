...
?>
<?php
$sql=mysqli_query($con,"select * from designer");
?>
<!--
Author: W3layouts
                ...
                <div class="w3breadcrumb-gids">
                    ...
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span>Our Designer</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="team" class="w3lteam py-5">
        <div class="container py-md-5">
            <div class="title-content text-center">
                <h6 class="title-subw3hny mb-1">Our Designer & Parteners</h6>
                <h3 class="title-w3l mb-5">Our Creative Designer Team.</h3>
            </div>
            <div class="row">
                <?php
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="AdminPanel/images/<?php echo $row["image"]; ?>"  class="img-fluid radius-image" alt=""></div>
                        <div class="member-info">
                            <h6><?php echo $row["d_name"]; ?></h6>
                            <h7><?php echo $row['d_description']; ?></h7>
                            <div class="social">
                            </div>
                        </div>
                    </div>
