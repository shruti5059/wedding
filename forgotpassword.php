...
session_start();
    ...
    require 'AdminPanel/connect.php';
     if(isset($_REQUEST['sub']))
     {
        ...
        $log=mysqli_query($con,"select * from client_register where email='$email'");
        ...
        {
            $danger="Your Email ID Incorrect..!!!";
        }
    }
               ...
               <?php } ?>
                ...
                <form action="#" method="post">
                    ...
                    <div class="submit-button text-center">
                        <button type="submit"class="btn btn-style btn-primary" name="sub">Send OTP</button>
