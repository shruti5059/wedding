...
if(isset($_POST['order'])){
   ...
   $cart_query = $conn->prepare("SELECT * FROM `cart` WHERE cart_client_id = ?");
   $cart_query->execute([$cart_client_id]);
...
<section class="display-orders">
   ...
   <?php
      $cart_grand_total = 0;
      $select_cart_items = $con->prepare("SELECT * FROM `cart` WHERE cart_client_id = ?");
      $select_cart_items->execute([$cart_client_id]);
