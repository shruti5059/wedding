...
if(isset($_REQUEST['sub']))
  {
    ...
    if($new == $confirm)
    {
        $sql=mysqli_query($con,"update client_register set password='$new' where email='$email'");
        if($sql)
        {
                ...
                <div class="w3breadcrumb-gids">
                    ...
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span>Confirm Password</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="form-wrapv">
               ...
               <?php } ?>
                ...
                <form action="#" method="post">
                    ...
                    <div class="form-sub-w3">
                        <input type="password" name="conpass" placeholder="Enter Confirm Password" required="" />
                        
                    </div>
                    
                    
                    <div class="submit-button text-center">
                        <button type="submit"class="btn btn-style btn-primary" name="sub">Confirm New Password</button>
