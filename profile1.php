<?php 
    ...
    $sql=mysqli_query($con,"select * from  client_register where email='$email'");
...
<?php 
    if(isset($_REQUEST['sub']))
    {
        ...
        {
            $update=mysqli_query($con,"update client_register set user_name='$user_name',email='$email',password='$password',phoneno='$phoneno',address='$address'  where c_id=$c_id");
           if($update)
           {
...
<center><div class="card-header"> <h4><a href="index.php" class="previous round" style="background: white;">&#8249;Back</a></h4>
</div></center> 
            ...
            <div class="form-wrapv">
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-sub-w3">
                        <input type="hidden" name="c_id" placeholder="Username " value="<?php echo $row['c_id']; ?>" required="" />
                    
                    </div>
                    <div class="form-sub-w3">
                        <input type="text" name="user_name" placeholder="Username " value="<?php echo $row['user_name']; ?>" required="" />
                        <div class="icon-w3">
                    ...
                    <div class="form-sub-w3">
                        <input type="text" name="phoneno" placeholder="Phone Number " value="<?php echo $row['phoneno']; ?>" required="" />
                        <div class="icon-w3">
                            <span  aria-hidden="true"></span>
                        </div>
                    </div>
                 ...
                 <!--   <div class="form-sub-w3">
                        <input type="file" name="file" placeholder="Image " value="<?php echo $row['image']; ?>"required="" />
                        <div class="icon-w3">
                            <span  aria-hidden="true"></span>
                        </div>
                    </div>-->
                    <div class="submit-button text-center">
                        <button class="btn btn-style btn-primary" name="sub" type="submit">Register Now</button>
